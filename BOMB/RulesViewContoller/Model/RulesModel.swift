...
struct RulesModel {
    ...
    let categoriesPageRows: [RulesCellViewModel] = [
        .title("Категории"),
        .text("В игре доступно 5 категорий, в каждой из которых содержится 15 вопросов."),
    ...
    let settingsPageRows: [RulesCellViewModel] = [
        ...
        .timeDurationLabel(UIImage(named: "short"), "Бомба взорвётся в течение 10 секунд."),
        .timeDurationLabel(UIImage(named: "middle"), "Бомба взорвётся в течение 20 секунд."),
        .timeDurationLabel(UIImage(named: "long"), "Бомба взорвётся в течение 45 секунд."),
        .timeDurationLabel(UIImage(named: "random"), "Бомба взорвётся в течение 10-45 секунд."),
